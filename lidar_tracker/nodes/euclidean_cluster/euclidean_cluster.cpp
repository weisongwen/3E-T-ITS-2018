		...
		*out_cloud_ptr = *out_cloud_ptr + *(final_clusters[i]->GetCloud());
				...
				)
		{
			...
			**********************************************************************/
			...
			{
				{
					bounding_box.dimensions.z=8.8; // this is height of double-decker bus
			        ...
			        double elevation_max_point=atan2(3.7,sqrt(cloud_cluster.max_point.point.x *cloud_cluster.max_point.point.x
			        ...
			        double elevation_min_point=atan2(3.7,sqrt(cloud_cluster.min_point.point.x *cloud_cluster.min_point.point.x
