...
class csv2Topi():
    ...
    def fastReadCSV(self,GNSSBegin, GNSSEnd):
        ...
        self.Fcsv_GNSS = csv.reader(open('/home/wenws/20180305/sv_data820180305.csv',
...
if __name__ == '__main__':
    ...
    csv2Topi_.fastReadCSV(138713000,138810000) # the value is provided by bag file in topci '/novatel_data/bestpos'
